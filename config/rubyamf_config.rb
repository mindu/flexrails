...
module RubyAMF
  module Configuration
    ...
    # ClassMappings.register(:actionscript => 'vo.MessageVO', :ruby => 'Message')
    
 # ClassMappings.register(:actionscript => 'Message', :ruby => 'Message', :type => 'active_record')
 ClassMappings.register(:actionscript => 'vo.MessageVO', :ruby => 'Message', :type => 'active_record', :attributes => ["id", "text"])    
